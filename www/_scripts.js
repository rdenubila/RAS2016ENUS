...
$(document).ready(function($) {
	...
	/*if(isIE){
		...
		$("#video_intro").html('<div id="videoFLV"></div>');



		swfobject.embedSWF("video/"+idioma+"/fundo.swf", "videoFLV", "100%", "100%", "9.0.0","js/expressInstall.swf", flashvars, params, attributes);

	} else {

		$("#video_intro").html('<video id="video_player" width="100%" height="100%" webkit-playsinline><source src="video/'+idioma+'/video.mp4" type="video/mp4"><source src="video'+idioma+'video.webm" type="video/webm"><source src="video'+idioma+'video.ogg" type="video/ogg"></video>');
